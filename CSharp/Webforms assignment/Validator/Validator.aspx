...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="textaddress" ErrorMessage="Must be &gt;2 characters" ForeColor="Red" ValidationExpression="&quot;^[\s\S]{2,10}$&quot;">*</asp:RegularExpressionValidator>
            </p>
            <p>City :&nbsp;&nbsp;&nbsp;
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="textcity" ErrorMessage="Must be &gt;2 characters" ForeColor="Red" ValidationExpression="&quot;^[\s\S]{2,10}$&quot;">*</asp:RegularExpressionValidator>
            </p>
            <p>Zip Code :&nbsp;&nbsp;&nbsp;
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="textpin" ErrorMessage="Must be &gt;2 characters" ForeColor="Red" ValidationExpression="&quot;^[\s\S]{5,10}$&quot;">*</asp:RegularExpressionValidator>
            </p>
            <p>Phone :&nbsp;&nbsp;&nbsp;
